          ...
          if (_timer <= 0) {
            setState(() {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('오늘 $_pomodoroCount개의 뽀모도를 달성했습니다!'),
                ),
              );
            });
            t.cancel();
      ...
      ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
              backgroundColor: _timerStatus == TimerStatus.resting
                  ...
                  : Colors.blue),
          child:
              Text('시작하기', style: TextStyle(color: Colors.white, fontSize: 16)))
    ];
    return Scaffold(
      appBar: AppBar(
        title: Text('뽀모도로 타이머'),
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Text(
                '${(_timer / 60).floor()} : ${(_timer % 60).toString().padLeft(2, '0')}',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 40,
          ...
          Row(
            ...
            children: _timerStatus == TimerStatus.resting // 휴식 중이냐?
                ? const [] // 아예 버튼 없이
